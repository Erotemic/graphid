...
class AnnotInfrMatching:
    ...
    def exec_vsone_subset(infr, edges, prog_hook=None):
        ...
        Example:
            >>> # xdoctest: +SKIP('no testdata_infr')
...
class _RedundancyAugmentation:
    ...
    def find_pos_redun_candidate_edges(infr, k=None, verbose=False):
        ...
        CommandLine:
            xdoctest -m graphid.ibeis.mixin_matching _RedundancyAugmentation.find_pos_redun_candidate_edges
...
class CandidateSearch(_RedundancyAugmentation):
    ...
    def find_lnbnn_candidate_edges(infr):
        ...
        Example:
            >>> # xdoctest: +REQUIRES(module:ibeis)
            >>> from graphid.ibeis import ibeis_demo
            >>> infr = ibeis_demo.demodata_mtest_infr()
