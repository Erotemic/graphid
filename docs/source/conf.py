...
Notes:
    ...
    cd ~/code/graphid/docs
    sphinx-apidoc --private -f -o ~/code/graphid/docs/source ~/code/graphid/graphid --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/graphid/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: graphid
            Set the Repository URL: https://github.com/Erotemic/graphid

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/graphid/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/graphid/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/graphid/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'graphid', '__init__.py')
...
# html_logo = '.static/graphid.svg'
# html_favicon = '.static/graphid.ico'
...
latex_documents = [
    (master_doc, 'graphid.tex', 'graphid Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'graphid', 'graphid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'graphid', 'graphid Documentation',
     author, 'graphid', 'One line description of project.',
     'Miscellaneous'),
]
