...
if __name__ == "__main__":
    ...
    setupkw["url"] = "https://github.com/Erotemic/graphid"
    setupkw["description"] = (
        "The graph identification algorithm from Jon Crall's thesis"
    )
